...
const LABEL_DEFAULT = 'M0 10C0 4.47715 4.47715 0 10 0H248.092C255.204 0 260.042 7.21371 257.345 13.7935L245.045 43.7935C243.505 47.548 239.85 50 235.792 50H10C4.47715 50 0 45.5228 0 40V10Z';
const LABEL_HOVER   = 'M0 10C0 4.47715 4.47715 0 10 0H235.792C239.85 0 243.505 2.452 245.045 6.2065L257.345 36.2065C260.042 42.78629 255.204 50 248.092 50H10C4.47715 50 0 45.5228 0 40V10Z';

// Right side frozen — only left angled corners morph
const ICON_DEFAULT = 'M72.6025 40C72.6025 45.5228 68.1254 50 62.6025 50H10.0104C2.89902 50 -1.93984 42.7863 0.757887 36.2065L13.0579 6.20647C14.5972 2.45204 18.2527 0 22.3104 0H62.6025C68.1254 0 72.6025 4.47715 72.6025 10V40Z';
const ICON_HOVER   = 'M72.6025 40C72.6025 45.5228 68.1254 50 62.6025 50H22.3104C18.2527 50 14.5972 47.54796 13.0579 43.79353L0.757887 13.7935C-1.93984 7.2137 2.89902 0 10.0104 0H62.6025C68.1254 0 72.6025 4.47715 72.6025 10V40Z';
...
export default function SplitCTA({
  ...
  const animate = useCallback((toHover: boolean) => {
    ...
    const frame = (now: number) => {
      ...
      arrowHovRef.current?.setAttribute('transform', arrowTransform(ARROW_CX + (p - 1) * ARROW_SLIDE));
  ...
  return (
    ...
    >
      <span className="btn_label button-mono">
        <svg className="btn_label_shape" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 259 50" preserveAspectRatio="none" aria-hidden>
      ...
      <i className="btn_icon" aria-hidden>
        ...
        */}
        ...
        >
          ...
          {/* pill background */}
          <path ref={iconBgRef} className="btn_icon_bg" fill="var(--btn-arrow-bg, #3b86d2)" d={ICON_DEFAULT} />
          ...
          <g clipPath={`url(#${clipId})`}>
            ...
            <g ref={arrowDefRef} transform={arrowTransform(ARROW_CX)}>
              <path d={ARROW_PATH} stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" vectorEffect="non-scaling-stroke" />
            </g>
            {/* hover arrow — enters from left on hover, always white */}
            <g ref={arrowHovRef} transform={arrowTransform(ARROW_CX - ARROW_SLIDE)}>
              <path d={ARROW_PATH} stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" vectorEffect="non-scaling-stroke" />
            </g>
          </g>
        </svg>
      </i>
