...
/**
 * Reusable Tailwind class string for the shine hover sweep effect.
 * Apply to any element that has a solid background color.
 * The element must also be `relative overflow-hidden` (included here).
 */
export const shineHoverClass =
...
const ButtonShineHoverDemo = () => {
  return (
    <Button
      className={`text-white bg-blue-500 hover:bg-blue-500/80 ${shineHoverClass} cursor-pointer`}
    >
      Shine Hover
    </Button>
  );
