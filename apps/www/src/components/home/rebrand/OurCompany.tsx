...
export default function OurCompany() {
  return (
    ...
    >
      ...
      <div
        className="w-full px-6 md:px-12 pt-0 pb-24 md:pb-[126px] grid grid-cols-1 md:grid-cols-[2fr_2fr] gap-8 md:gap-12 items-stretch"
      ...
      >
          ...
          >
            ...
            <div className="absolute bottom-5 left-5 right-5 flex items-end justify-between pointer-events-none">
              <div className="flex flex-col gap-0.5">
                <span className="text-white font-sans font-normal text-lg leading-tight">Steven Nhan</span>
                <span className="button-mono text-xs text-white/60 uppercase tracking-[0.15em]">Founder &amp; CEO</span>
              </div>
            </div>
        ...
        <div className="flex flex-col justify-between" id="company-main-content">
          ...
          >
            <div className="overflow-hidden pb-[0.04em]">
              <motion.span className="block" variants={line}>Built to support the</motion.span>
            </div>
            <div className="overflow-hidden pb-[0.04em]">
              <motion.span className="block" variants={line}>people who run modern</motion.span>
            </div>
            <div className="overflow-hidden pb-[0.04em]">
              <motion.span className="block" variants={line}>businesses.</motion.span>
            </div>
          </motion.h2>
          ...
          >
            <div className="overflow-hidden">
              <motion.p
                ...
                id="company-text-column-1"
              >
                SN International Group was founded on a simple belief: the right support, matched carefully to the right team, changes what founders and operators can achieve. We build offshore support teams that slot into your workflow — not the other way around.
              </motion.p>
            </div>
            ...
            <div className="overflow-hidden">
              <motion.p
                ...
                className="text-[#0c1d2e]/65 text-[15px] sm:text-base font-normal tracking-[-0.04em]"
                style={{ lineHeight: '1.35' }}
                id="company-text-column-2"
              >
                Every specialist we place is vetted, briefed on your business, and ready to execute from day one. Our AU and US coverage windows mean your work keeps moving regardless of timezone.
              </motion.p>
            </div>
          </motion.div>
