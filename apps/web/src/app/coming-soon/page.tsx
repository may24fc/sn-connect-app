  ...
  return (
    <div className="flex h-full items-center justify-center">
      <div className="text-center space-y-4 max-w-md">
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-slate-50 dark:bg-zinc-950/50">
          <Construction className="h-8 w-8 text-slate-700 dark:text-zinc-400" strokeWidth={1.5} />
        </div>
