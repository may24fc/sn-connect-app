...
import ExpenseAnalyticsDashboardPage from '@/app/(admin)/admin/expenses/analytics/page';
...
export default function EmployeeExpensesDeskAnalyticsPage() {
      ...
      <div className="flex h-screen items-center justify-center p-8 bg-zinc-50 dark:bg-zinc-950 text-center">
        <div className="max-w-md space-y-4">
          ...
          <p className="text-zinc-500 text-sm">
            Only Accounting members and System Administrators are authorized to access expense analytics.
          </p>
  ...
  return <ExpenseAnalyticsDashboardPage />;
}
