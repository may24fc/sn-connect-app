...
export const NOTIFICATION_ADMIN_ROLES = ['admin', 'super_admin', 'hr', 'cos', 'ceo'];
...
export function isNotificationAdmin(role: string | null): boolean {
  return role ? NOTIFICATION_ADMIN_ROLES.includes(role) : false;
}
