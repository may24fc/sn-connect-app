...
const ACTION_LABELS: Record<string, string> = {
  ...
  create_performance_review: 'Created a review',
  update_performance_review: 'Updated a review',
  // Knowledge base
...
const TABLE_CATEGORIES: Record<string, { label: string; category: string }> = {
  ...
  review_cycles: { label: 'OKRs & KPIs', category: 'performance' },
  performance_reviews: { label: 'OKRs & KPIs', category: 'performance' },
  okrs: { label: 'OKRs & KPIs', category: 'performance' },
  okr_targets: { label: 'OKRs & KPIs', category: 'performance' },
