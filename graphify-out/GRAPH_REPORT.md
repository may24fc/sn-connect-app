...
1. `cn()` - 355 edges
2. `createSupabaseAdminClient()` - 249 edges
3. `createSupabaseServerClient()` - 227 edges
4. `useToast()` - 215 edges
5. `logActivity()` - 201 edges
6. `Button` - 184 edges
7. `Card` - 145 edges
8. `CardContent` - 144 edges
9. `Badge()` - 138 edges
10. `CardHeader` - 104 edges
...
### Community 140 - "Vercel Quick Start Guide"
Cohesion: 0.08
...
### Community 166 - "Announcement Components Reference"
Cohesion: 0.20
...
### Community 171 - "checklist-templates/route.ts"
Cohesion: 0.23
...
### Community 207 - "pa-tasks/route.ts"
Cohesion: 0.25
...
### Community 243 - "drive-watch-renew/route.ts"
Cohesion: 0.39
...
### Community 250 - "4. Test Each Role"
Cohesion: 0.22
...
### Community 262 - "Data Display Components Reference"
Cohesion: 0.25
Nodes (7): BentoGrid, Data Display Components Reference, DataTable, EmptyState, Key Features, StatCard, Usage

### Community 263 - "Sidebar.tsx"
Cohesion: 0.11
Nodes (23): adminInternalSectionConfig, adminNavItems, createWorkspaceSections(), employeeAtsNavItems, employeeNavItems, exactOnlyNavHrefs, getNavMatchLength(), getWorkspaceForPath() (+15 more)

### Community 264 - "Internship Components Reference"
Cohesion: 0.25
...
### Community 265 - "useRevenueForecastEntries.ts"
Cohesion: 0.22
...
### Community 266 - "useIndividualPerformance.ts"
Cohesion: 0.29
...
### Community 281 - "Deployment Documentation"
Cohesion: 0.12
...
Cohesion: 0.40
Nodes (5): DELETE(), GET(), PATCH(), validatePaTaskAssignee(), paTaskUpdateSchema
...
### Community 330 - "Feedback Components Reference"
Cohesion: 0.40
...
### Community 373 - "ResourceDetailPanel"
Cohesion: 0.50
...
### Community 687 - "useRevenueForecastGoals.ts"
Cohesion: 0.28
